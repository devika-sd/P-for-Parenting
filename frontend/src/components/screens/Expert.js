            ...
            return (
                <div key={{ i }} style={{ backgroundColor: 'rgb(246, 248, 250)', margin: '20px', padding: '10px' }}>
                    ...
                    {(this.state.openIndex === i) ?
                        <div>
                            <input style={{margin:'20px 5px 0 20px'}} /*onChange={() => { this.setOpen(i, value._id) }}*/ className="form-check-input" type="radio" name="does" id="does" defaultValue={true} />&nbsp;
                            ...
                            <textarea onChange={this.answerContent.bind(this)} style={{ margin: '20px', width: '96%', backgroundColor: 'rgb(226, 226, 226)', height: '200px' }} class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
